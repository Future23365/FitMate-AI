...
export const productionAgentTools = [readRecentVisibleTrainingProposalTool, searchExerciseResourcesTool] as const;

export { readRecentVisibleTrainingProposalTool, searchExerciseResourcesTool };
