...
(function () {
  ...
  window.setTimeout(function () {
    ...
    if (!notice) {
      ...
      notice.innerHTML = '<div class="fitmate-root-boot-notice__panel"><div class="fitmate-root-boot-notice__mark" aria-hidden="true">!</div><div class="fitmate-root-boot-notice__copy"><p class="fitmate-root-boot-notice__title">访问可能较慢</p><p class="fitmate-root-boot-notice__description">如果页面长时间停留在加载状态，可能与跨境网络有关。你可以尝试切换网络，或使用稳定的代理环境访问。</p></div></div>';
