      ...
      output: {
        ...
        query: {
          ...
          appliedFilters: [
            ...
            { field: "requiresExternalEquipment", value: false },
            { field: "supportRequirementTags", value: ["none"] },
            { field: "setupComplexityMax", value: "zero_setup" },
            { field: "muscles", value: ["胸部"] },
          ],
          filterApplications: [{
            section: "training",
            hardFilterPolicy: "training",
            appliedHardFilters: ["suitabilities", "exerciseNames", "requiresExternalEquipment", "supportRequirementTags", "setupComplexityMax", "muscles"],
            unappliedInputFilters: [],
          }],
          filterSemantics: [{
            field: "setupComplexityMax",
            requestedValue: "zero_setup",
            databaseMapping: {
