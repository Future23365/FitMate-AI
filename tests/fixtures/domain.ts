...
export function createExercise(overrides: Partial<Exercise> = {}): Exercise {
  ...
  return {
    ...
    requiresExternalEquipment: overrides.requiresExternalEquipment ?? null,
    requiredEquipmentTags: overrides.requiredEquipmentTags ?? [],
    supportRequirementTags: overrides.supportRequirementTags ?? [],
    setupComplexity: overrides.setupComplexity ?? "unknown",
