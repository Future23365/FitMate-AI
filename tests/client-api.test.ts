  ...
  it("passes chat payload and consumes multi-line NDJSON text events", async () => {
    const fetchMock = vi
      ...
      .mockResolvedValueOnce(new Response([
        ...
        JSON.stringify({ type: "agent_progress", stage: "analyzing_request", status: "active", messageKey: "analyzing_request", activitySummary: "I am checking the exercise facts now.", sequence: 3 }),
    ...
    expect(events).toEqual([
      ...
      { type: "agent_progress", stage: "analyzing_request", status: "active", messageKey: "analyzing_request", activitySummary: "I am checking the exercise facts now.", sequence: 3 },
