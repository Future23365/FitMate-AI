...
function toTestExerciseListItem(exercise: Exercise): ExerciseListItem {
  return {
    ...
    requiresExternalEquipment: exercise.requiresExternalEquipment,
    requiredEquipmentTags: exercise.requiredEquipmentTags,
    supportRequirementTags: exercise.supportRequirementTags,
    setupComplexity: exercise.setupComplexity,
